...
def apply(project:Project,change:ChangeSet)->Project:
    ...
    mapping={o.id:uid() for o in change.operations if o.op=='add' and o.id.startswith('tmp:')}
    def resolve(v):
    ...
    for operation in change.operations:
        ...
        if o.op=='add':
            ...
            refs=[x for x in data['interfaces'] if o.id in [x['source'],x['target']]+x['enforcement']]
