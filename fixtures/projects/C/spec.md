# Conflicting requirements technical specification
...
Component cloud: name="External enrichment"; role="internet dependency"; asset_id="external-system"; scope="external"; system_id=null; zone_id=null; status="proposed"; internet_hosted=true
...
Interface dependency: source="analytics"; target="cloud"; purpose="required enrichment"; data_direction="bidirectional"; initiator="analytics"; protocol="HTTPS"

Constraint capacity: key="capacity_streams"; value=100

Constraint sizing: key="equipment_sizing"; value="undecided"

Constraint availability: key="availability_strategy"; value="single_instance_no_recovery"
