# Baseline VAP integration technical specification

SYNTHETIC — DEMONSTRATION ONLY

Integrate existing video management with a new video analytics platform. Keep application responsibilities separate from deployment sizing. Existing C2 is outside the VAP system boundary and its internal zoning is unspecified.
...
Constraint availability: key="availability_strategy"; value="single_instance"
